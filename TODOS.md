...
**What:** After enabling flash attention on A15+ (already in V1 scope), benchmark Qwen/Gemma/LFM specifically. Confirm 20-30% speedup claim and verify no output quality regression.
