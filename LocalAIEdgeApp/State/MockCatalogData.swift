...
enum MockCatalogData {
    ...
    static let items: [ModelCatalogItem] = [
        ...
        ModelCatalogItem(
            ...
            family: .qwen,
            variant: "4-bit MLX · Vision",
            summary: "Compact Qwen 3.5 vision-language model. Source weights are vision-capable, but the bundled MLX runtime rejected this architecture during iPhone 17 Pro audit.",
            parameterSize: "0.8B",
            quantization: "MLX 4-bit",
            diskSize: "~1.0 GB",
            contextWindow: "256K",
            ...
            supportsVision: false,
            runtimeStatus: .unsupported,
            auditVerdict: .red("unsupported-mlx-architecture"),
            testedDeviceTier: .pro,
            minimumTier: .pro,
            inputModes: []
        ),
        ModelCatalogItem(
            ...
            family: .qwen,
            variant: "4-bit MLX · Vision",
            summary: "Qwen 3.5 4B vision-language model. Source weights are vision-capable, but this architecture is not enabled by the bundled MLX runtime yet.",
            parameterSize: "4B",
            quantization: "MLX 4-bit",
            diskSize: "~3.0 GB",
            contextWindow: "256K",
        ...
        ModelCatalogItem(
            ...
            family: .lfm,
            variant: "4-bit MLX · Vision",
            summary: "Liquid LFM2.5 vision-language model. Source weights are vision-capable, but the bundled MLX runtime rejected this architecture during iPhone 17 Pro audit.",
            parameterSize: "1.6B",
            quantization: "MLX 4-bit",
            diskSize: "~1.5 GB",
            contextWindow: "32K",
