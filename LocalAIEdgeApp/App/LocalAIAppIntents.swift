...
enum LocalAIIntentDestination: String, AppEnum {
    ...
    static var typeDisplayRepresentation = TypeDisplayRepresentation(name: "EdgeMind AI Destination")
...
struct OpenLocalAIDestinationIntent: AppIntent {
    static var title: LocalizedStringResource = "Open EdgeMind AI"
    static var description = IntentDescription("Open EdgeMind AI to a selected on-device AI workflow.")
...
struct AskDefaultLocalModelIntent: AppIntent {
    static var title: LocalizedStringResource = "Ask EdgeMind AI"
    static var description = IntentDescription("Open EdgeMind AI with a prompt for the default local model.")
    static var openAppWhenRun = true
...
struct StartLocalVoiceChatIntent: AppIntent {
    static var title: LocalizedStringResource = "Start EdgeMind AI Voice Chat"
    static var description = IntentDescription("Open EdgeMind AI ready for voice input.")
    static var openAppWhenRun = true
...
struct LocalAIShortcutsProvider: AppShortcutsProvider {
    static var appShortcuts: [AppShortcut] {
        AppShortcut(
            ...
            phrases: [
                "Ask \(.applicationName)",
                "Ask EdgeMind AI in \(.applicationName)"
            ],
            shortTitle: "Ask EdgeMind AI",
        ...
        AppShortcut(
            ...
            phrases: [
                ...
                "Check EdgeMind AI models in \(.applicationName)"
            ],
        ...
        AppShortcut(
            ...
            phrases: [
                ...
                "Talk to EdgeMind AI in \(.applicationName)"
            ],
        ...
        AppShortcut(
            ...
            phrases: [
                ...
                "Show EdgeMind AI models in \(.applicationName)"
            ],
