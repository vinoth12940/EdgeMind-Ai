...
struct PrivacyExplainerView: View {
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("EdgeMind AI is designed for local AI inference. Network requests are limited to actions you enable or start, such as model downloads and live search.")
                .font(.appBody(14))
