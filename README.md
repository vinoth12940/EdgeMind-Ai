...
| AI Labs | 10 |
| Search providers | 4 |
| Unit tests | 321 XCTest test cases covering hardware tiering, device capabilities, catalog consistency, runtime profiles, streaming, memory guards, and agentic tools |
