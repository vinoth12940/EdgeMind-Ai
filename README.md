...
| AI Labs | 10 |
| Search providers | 4 |
| Unit tests | 522 XCTest test cases covering hardware tiering, device capabilities, catalog consistency, runtime profiles, streaming, memory guards, the chat turn engine, answer versions, chat export, model suggestions, personal memory, document search, share import, prompt budgeting, OCR fallback, Foundation Models, inline Markdown stack safety, and agentic tools |
