...
| AI Labs | 10 |
| Search providers | 4 |
| Unit tests | 334 XCTest test cases covering hardware tiering, device capabilities, catalog consistency, runtime profiles, streaming, memory guards, the chat turn engine, and agentic tools |
